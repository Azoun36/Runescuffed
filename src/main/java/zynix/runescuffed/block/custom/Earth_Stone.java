...
public class Earth_Stone extends Block {
    public Earth_Stone(Settings settings) {
        super(settings);
    }
    ...
    public void onSteppedOn(World world, BlockPos pos, BlockState state, Entity entity) {
        if (!world.isClient() && entity instanceof ItemEntity itemEntity) {
            ...
            if (isValidItem(inputStack)) {
                ...
                itemEntity.setStack(new ItemStack(ModItems.EARTH_RUNE, newCount));

                world.playSound(null, pos, SoundEvents.BLOCK_BASALT_BREAK, SoundCategory.BLOCKS, 1f, 1f);
