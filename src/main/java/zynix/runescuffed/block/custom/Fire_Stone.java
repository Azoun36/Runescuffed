...
public class Fire_Stone extends Block {
    public Fire_Stone(Settings settings) {
        super(settings);
    }
    ...
    public void onSteppedOn(World world, BlockPos pos, BlockState state, Entity entity) {
        if (!world.isClient() && entity instanceof ItemEntity itemEntity) {
            ...
            if (isValidItem(inputStack)) {
                ...
                world.playSound(null, pos, SoundEvents.ENTITY_BLAZE_BURN, SoundCategory.BLOCKS, 1f, 1f);
